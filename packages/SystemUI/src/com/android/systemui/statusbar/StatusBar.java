...
public abstract class StatusBar extends SystemUI implements CommandQueue.Callbacks {
    ...
    private void refreshWeather() {
        ...
        weatherintent.putExtra("com.blackice.control.INTENT_EXTRA_ISMANUAL", false);
    ...
    public static void resetColors(Context c) {
        Settings.System.putInt(c.getContentResolver(), Settings.System.STATUSBAR_CLOCK_COLOR,
                Integer.MIN_VALUE);
        Settings.System.putInt(c.getContentResolver(), Settings.System.STATUSBAR_BATTERY_TEXT_COLOR,
                Integer.MIN_VALUE);
        ...
        Settings.System.putInt(c.getContentResolver(), Settings.System.STATUSBAR_SIGNAL_TEXT_COLOR,
                Integer.MIN_VALUE);
        Settings.System.putInt(c.getContentResolver(), Settings.System.STATUSBAR_NOTIFICATION_COLOR,
                Integer.MIN_VALUE);
