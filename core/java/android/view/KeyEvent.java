...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    public static final int KEYCODE_TOGGLE_WIFI     = 213;
    public static final int KEYCODE_TOGGLE_BT       = 214;
    public static final int KEYCODE_TOGGLE_TOUCHPAD = 215;
    public static final int KEYCODE_BRIGHTNESS_DOWN = 216;
    public static final int KEYCODE_BRIGHTNESS_UP   = 217;
    public static final int KEYCODE_BRIGHTNESS_AUTO = 218;
    public static final int KEYCODE_SCREENSHOT      = 219;
